...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*RunnerSpec)(nil), (*v1alpha2.RunnerSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha1_RunnerSpec_To_v1alpha2_RunnerSpec(in *RunnerSpec, out *v1alpha2.RunnerSpec, s conversion.Scope) error {
	...
	out.OS = in.OS
	// WARNING: in.Group requires manual conversion: does not exist in peer-type
...
func autoConvert_v1alpha2_RunnerSpec_To_v1alpha1_RunnerSpec(in *v1alpha2.RunnerSpec, out *RunnerSpec, s conversion.Scope) error {
	...
	out.ID = (*int64)(unsafe.Pointer(in.ID))
	out.OS = in.OS
	// WARNING: in.DeprecatedGroup requires manual conversion: does not exist in peer-type
	// WARNING: in.GroupID requires manual conversion: does not exist in peer-type
	out.Workdir = in.Workdir
