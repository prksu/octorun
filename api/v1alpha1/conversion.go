...
func Convert_v1alpha1_RunnerSpec_To_v1alpha2_RunnerSpec(in *RunnerSpec, out *v1alpha2.RunnerSpec, scope apiconversion.Scope) error {
	out.DeprecatedGroup = in.Group
	return autoConvert_v1alpha1_RunnerSpec_To_v1alpha2_RunnerSpec(in, out, scope)
}
